...
const About = () => {
  return (
    <div className={Styles.wrapper}>
        ...
        <p className={Styles.text}>This may be the future. This may not. Who knows.</p>
        <p className={Styles.text}>But at least it seems to be solving an actual problem 🤷‍♀️.</p>
    </div>
  )
}
